  ...
  return (
    <section className="max-w-7xl mx-10 2xl:mx-auto bg-white rounded-xl px-10 py-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center items-center gap-3">
        ...
        {/* নামাজ */}
        <div className="grid grid-cols-2 justify-items-center items-center w-full lg:w-64 border border-accent rounded-xl px-2 py-1">
          <h2 className="text-center text-black font-bold">নামাজ</h2>
        ...
        {/* কাজা নামাজ */}
        <div className="grid grid-cols-2 justify-items-center items-center w-full lg:w-64 border border-accent rounded-xl px-2 py-1">
          <h2 className="text-center text-black font-bold px-2">কাজা নামাজ</h2>
        ...
        {/* জামাতে পড়েছেন  */}
        <div className="grid grid-cols-2 justify-items-center items-center w-full lg:w-64 border border-accent rounded-xl px-2 py-1">
          <h2 className="text-center text-black font-bold">জামাতে পড়েছেন </h2>
        ...
        <div className="grid grid-cols-2 justify-items-center items-center w-full lg:w-64 border border-accent rounded-xl px-2 py-1">
          <h2 className="text-center text-black font-bold">তাকবীরে-উলার সাথে পড়েছেন</h2>
